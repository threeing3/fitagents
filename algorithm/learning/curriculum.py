...
CURRICULUM: tuple[ModuleCard, ...] = (
    ...
    ModuleCard(
        ...
        ("algorithm/data/export_traces.py", "algorithm/data/sanitize.py", "algorithm/data/split_dataset.py"),
        (
    ...
    ModuleCard(
        ...
        "意图识别与路由基线",
        "应用算法",
        "能从规则基线出发，定义分类标签、混淆矩阵和 Macro-F1，并设计规则/轻量模型/大模型的公平对比。",
        ("01_data_contracts",),
        ("classification", "precision/recall", "Macro-F1", "confusion matrix", "class imbalance"),
        ("algorithm/app_algorithms/intent_baseline.py", "tests/evals/intent_eval_cases.json"),
        ...
        ("Macro-F1 >= 0.85", "风险 Recall 单独报告", "能解释至少一个混淆案例"),
    ),
    ModuleCard(
    ...
    ModuleCard(
        ...
        ("algorithm/app_algorithms/tool_plan_eval.py", "algorithm/app_algorithms/response_reranker.py"),
        ("python -m pytest -q tests/algorithm/test_algorithm_metrics.py",),
        (
    ...
    ModuleCard(
        ...
        ("algorithm/training/sft/train_qlora.py", "algorithm/training/dpo/train_dpo.py", "algorithm/training/configs"),
        (

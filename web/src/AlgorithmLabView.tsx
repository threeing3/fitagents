...
export function AlgorithmLabView() {
  ...
  useEffect(() => {
    Promise.all([fetchAgentLabRuns(), fetchAgentChallenges(), fetchAlgorithmSummary()])
      .then(async ([runRows, challengeReport, algorithmSummary]) => {
        setRuns(runRows);
